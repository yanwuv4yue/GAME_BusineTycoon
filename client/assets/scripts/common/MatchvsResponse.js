...
MatchvsResponse.prototype.joinRoomResponse = function (status, userInfoList, roomInfo) {
    if (status === 200) {
        ...
        // var player ={userID:global.userID,userName: global.name};
        // MatchvsResponse.prototype.roomUserInfoListChangeNotify(userInfoList,"joinRoom",player,roomInfo.owner);
    } else {
...
MatchvsResponse.prototype.joinRoomNotify = function (roomUserInfo) {
    ...
    // MatchvsResponse.prototype.roomUserInfoListChangeNotify(roomUserInfo,"joinRoomNotify",player,0);
...
MatchvsResponse.prototype.leaveRoomResponse = function (leaveRoomRsp) {
    if (leaveRoomRsp.status === 200) {
        ...
        // MatchvsResponse.prototype.roomUserInfoListChangeNotify(leaveRoomRsp,"leaveRoom",player,0);
...
MatchvsResponse.prototype.leaveRoomNotify = function (leaveRoomInfo) {
    ...
    // MatchvsResponse.prototype.roomUserInfoListChangeNotify(leaveRoomInfo,"leaveRoom",player,leaveRoomInfo.owner);
...
MatchvsResponse.prototype.createRoomResponse = function (rsp) {
    if (rsp.status === 200) {
        ...
        // var player ={userID:global.userID,userName:  global.name};
        // MatchvsResponse.prototype.roomUserInfoListChangeNotify([],"joinRoom",player,global.userID);
...
MatchvsResponse.prototype.kickPlayerResponse = function (kickPlayerRsp) {
    if (kickPlayerRsp.status === 200) {
        ...
        // MatchvsResponse.prototype.roomUserInfoListChangeNotify(kickPlayerRsp,"leaveRoom",player,kickPlayerRsp.owner);
...
MatchvsResponse.prototype.kickPlayerNotify = function (kickPlayerNotify) {
    ...
    // MatchvsResponse.prototype.roomUserInfoListChangeNotify(kickPlayerNotify,"leaveRoom",player,kickPlayerNotify.owner);
...
MatchvsResponse.prototype.roomUserInfoListChangeNotify = function (data, action, player, ownerID) {
    ...
    // MatchvsResponse.prototype.sendEventToUI(msg.MATCHVS_ROOM_USERLIST_CHANGE_NOTIFY,{userList:userList,type:msg.MATCHVS_ROOM_USERLIST_CHANGE_NOTIFY});
};
